...
partial_serial_dev='ttyS1'
# partial_serial_dev='ttyS2'
# partial_serial_dev='tty0'
# partial_serial_dev='tty1'
# partial_serial_dev='tty2'
...
def read_concentration():
    try:
        ser = connect_serial()
        print('ser:'+str(ser))
        print('ser open status:' + str(ser.is_open))
