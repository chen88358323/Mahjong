    ...
    def clearCacheByKeyList(cache,klist):
        ...
        for key in cache.keys():
            if key in klist:
                ...
                delcache[key]=hcode
        # logger.info('缓存文件' + driverpath)
        return  cachep,delcache


    def getCachePath(self,dirpath):
